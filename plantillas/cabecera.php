...
<head>
    ...
    <title>Gestión Plataforma Séneca</title>
...
<body>
    ...
    <header class="align-items-center pb-3 mb-5 border-bottom">
        ...
        <h1 class="fs-4 text-center">Gestion de la Plataforma Séneca</h1>
    ...
    <aside class="col-lg-3">
        <nav>
            <ul>
                ...
                <li><a href="<?=$ruta?>vehiculos/registro.php">Insertar Vehículos</a></li>
            </ul>
        </nav>
    </aside>
